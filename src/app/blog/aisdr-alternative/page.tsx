...
const TITLE = "AiSDR alternative: rented AI SDR vs an engine you own";
const DESCRIPTION =
  "Honest comparison of AiSDR and a custom AI GTM engine. AiSDR is a subscription AI SDR platform; AI Ropeway ships an owned engine into your repo in 14 days. When each one wins.";
...
const faqs = [
  { q: "Is AI Ropeway an AiSDR competitor?", a: "They solve the same job — booking meetings from outbound — but with opposite models. AiSDR is a subscription AI SDR platform you log into. AI Ropeway builds a custom AI GTM engine and ships the code into your own GitHub repo, so you own it." },
...
const rows = [
  ["Product model", "Subscription AI SDR platform", "Custom AI GTM engine in your repo"],
