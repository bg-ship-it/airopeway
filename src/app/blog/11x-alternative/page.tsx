...
const DESCRIPTION =
  "Honest comparison of 11x (Alice) and a custom AI GTM engine. 11x is a subscription AI SDR platform; AI Ropeway ships an owned engine into your repo in 14 days. When each one wins.";
...
const rows = [
  ["Product model", "Subscription AI SDR platform (Alice)", "Custom AI GTM engine in your repo"],
      ...
      <article className="px-3 pt-6 pb-16 md:px-5 md:pt-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6 text-[17px] leading-[1.75] text-ink-soft">
            ...
            <p>11x is a platform you subscribe to. An AI Ropeway engine is built for your ICP and signals, ships into your GitHub repo, and runs in your own accounts. That means personalization grounded in the actual signal that fired, best-of-breed tools as data layers inside the engine, and a system you keep whether or not you renew.</p>
