      ...
      <article className="px-3 pt-6 pb-16 md:px-5 md:pt-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6 text-[17px] leading-[1.75] text-ink-soft">
            ...
            <p>Artisan is an all-in-one platform you rent. An AI Ropeway engine is built around your ICP and signals, ships into your stack, and runs in your own accounts. The difference shows up in fit and ownership: personalization grounded in the exact signal that fired, best-of-breed tools running as data layers inside the engine, and a system that keeps running whether or not you renew.</p>
