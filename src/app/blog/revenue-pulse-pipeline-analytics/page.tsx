...
const MODIFIED = "2026-06-25T08:00:00.000Z";
...
const sources: Source[] = [
  {
    ...
    note: "Event-log datastore every agent writes to; Revenue Pulse queries it for metrics.",
  },
  {
    publisher: "Tremor",
