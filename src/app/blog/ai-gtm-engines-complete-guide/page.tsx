...
const faqs = [
  ...
  },
  {
    ...
    a: "The full system lands in your stack with complete access on day one. No SaaS subscription holds your data hostage. If you fire AI Ropeway tomorrow, your AI GTM engine keeps running on your infrastructure. No per-seat fees, no per-message fees, no lock-in.",
  },
  {
