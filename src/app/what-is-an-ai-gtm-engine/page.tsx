      ...
      <article className="mx-auto max-w-3xl px-4 pt-20 pb-24 md:pt-28">
        <header className="mb-10">
          ...
          <p className="mt-5 text-lg leading-relaxed text-ink-soft">
            An <strong className="text-ink">AI GTM engine</strong> is a system of coordinated AI agents that automate go-to-market: detecting buying signals, enriching accounts, writing personalized outreach, and triaging replies. Unlike a SaaS tool you rent, an AI GTM engine is custom-built for your ICP and deployed in your own infrastructure — so you get full access from day one.
          </p>
        </header>
