      ...
      <div className="mx-auto max-w-4xl px-4 pt-20 pb-24 md:pt-28">
        <header className="mb-10 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-ink-soft">
            Hiring an SDR is a six-figure annual commitment before a single meeting is booked. Move the sliders to see the first-year math against an AI GTM engine shipped to your repo in 14 days.
          </p>
        </header>
        ...
        <section className="mt-14 space-y-4 text-[17px] leading-[1.75] text-ink-soft">
          ...
          <p>
            The difference most calculators miss: with an SDR hire you rent the output and lose it the day they leave. With an AI GTM engine, the code ships to <em>your</em> GitHub repo — you own it whether or not you keep working with us.
          </p>
