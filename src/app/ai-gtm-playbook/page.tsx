...
const checklist = [
  ...
  { phase: "Days 13–14 · Ship + hand over", items: ["Deploy the full system into the client’s stack with complete access", "CRM Auto-Pilot keeps stages + fields honest", "Revenue Pulse dashboard: pipeline, cost-per-meeting, agent performance", "Handoff walkthrough — the team can run it without us"] },
];
